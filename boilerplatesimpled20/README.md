...
This system is a simpled20 system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the SimpleD20 system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-simpled20-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `simpled20` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `simpled20` and `SimpleD20` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3SimpleD20 System](https://gitlab.com/asacolips-projects/foundry-mods/vue3simpled20) repo if you're interested in using Vue!
